...
class FSOUND_FLAGS(IntFlag):
    ...
    #Derived Constants
    #FSOUND_CHANNELMODE_MASK      = (
    #    FSOUND_FLAGS.FSOUND_CHANNELMODE_ALLMONO |
    #    FSOUND_FLAGS.FSOUND_CHANNELMODE_ALLSTEREO |
    #    FSOUND_FLAGS.FSOUND_CHANNELMODE_PROTOOLS
    #)
    #FSOUND_CHANNELMODE_DEFAULT   = 0x00000000
    #FSOUND_CHANNELMODE_RESERVED  = 0x00000C00